...
const features = [
  {
    icon: Bot,
    title: "IA ??? Lia 2.0",
    desc: "Sua assistente agora fala com seus dados reais. Pergunte sobre seu saldo, metas e pe??a para ela lan??ar gastos via texto ou voz.",
  },
  {
    icon: Landmark,
    title: "Open Finance Real",
    desc: "Esque??a mockups. Conecte mais de 25 bancos brasileiros via Pluggy e veja suas transa????es reais em segundos.",
  },
  {
    icon: TrendingUp,
    title: "Patrim??nio Consolidado",
    desc: "Vis??o 360?? de Ativos (contas, im??veis, carros) e Passivos. Saiba exatamente qual sua sa??de financeira atual.",
  },
  {
    icon: Target,
    title: "Gest??o por Objetivos",
    desc: "Crie metas inteligentes e deixe a IA calcular quanto tempo falta para voc?? atingir a liberdade financeira.",
  },
  {
    icon: Smartphone,
    title: "App Nativo (PWA)",
    desc: "Instale o Liberta no seu iPhone ou Android. Rapidez e fluidez de um app direto da App Store, sem ocupar espa??o.",
  },
  {
    icon: Shield,
    title: "Seguran??a de Elite",
    desc: "Autentica????o por CPF, criptografia banc??ria e prote????o de dados n??vel enterprise (LGPD compliant).",
  },
];
    ...
    <div className="min-h-screen bg-background dark:bg-gradient-hero overflow-hidden bg-grain">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32 text-center">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-medium bg-primary/10 text-primary border border-primary/20 mb-6 tracking-wide uppercase">
            7 dias gr??tis ??? requer cart??o de cr??dito
          </span>
        </motion.div>
        ...
        <motion.h1
          ...
          custom={1}
        >
          Liberte suas finan??as <br className="hidden md:block" />
          <span className="text-gradient text-glow">com prop??sito.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          custom={2}
        >
          Planeje, acompanhe e conquiste seus objetivos financeiros com intelig??ncia artificial, relat??rios avan??ados e uma experi??ncia pensada para simplificar sua vida.
        </motion.p>
        ...
        >
          <Link to="/register">
            <Button variant="hero" size="lg" className="text-base px-10 py-7 shadow-glow hover:scale-105 transition-transform">
              Come??ar Gr??tis Agora <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </Link>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Avalia????o M??dia</span>
          </div>
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Transa????es/m??s</span>
          </div>
        </motion.div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-10 max-w-lg leading-relaxed">
              Diga adeus ?? digita????o manual. Converse com a Lia por texto ou voz para automatizar lan??amentos e obter diagn??sticos precisos do seu patrim??nio.
            </p>

            <div className="space-y-8">
              {[
                { title: "Lan??amentos Autom??ticos", desc: "Diga 'Registrar despesa de R$ 350 com fornecedor X' e pronto." },
                { title: "Alertas Inteligentes", desc: "Rastreio constante de contas, faturas e fluxo de caixa em tempo real." },
                { title: "An??lise Preditiva", desc: "Receba previs??es de quando suas metas ser??o atingidas com base no seu perfil." }
              ].map((item, idx) => (
            ...
            <div className="glass-strong rounded-[2.5rem] p-8 shadow-2xl relative z-10 border-border/80 max-w-md mx-auto shadow-glow float-slow">
              ...
              <div className="space-y-6 mb-10 min-h-[220px]">
                <div className="glass p-4 rounded-3xl rounded-tl-none text-sm max-w-[90%] leading-relaxed">
                  Ol??! Eu sou a Lia ???? Sua assistente financeira inteligente. Com base no seu saldo atual de **R$ 12.450**, como posso ajudar seu patrim??nio a crescer hoje?
                </div>
                <div className="bg-primary/20 p-4 rounded-3xl rounded-tr-none text-sm ml-auto max-w-[85%] border border-primary/20 shadow-sm">
                  Qual a porcentagem da minha meta de Viagem eu j?? atingi?
                </div>
                <div className="glass p-4 rounded-3xl rounded-tl-none text-sm max-w-[90%] font-medium border-primary/10 leading-relaxed shadow-sm">
                  Voc?? j?? conquistou <span className="text-green-500 font-bold">54%</span> do seu objetivo! Com seu ritmo atual de economia, voc?? chegar?? l?? <span className="text-primary font-bold">3 meses antes</span> do previsto. ??????
                </div>
              </div>
        ...
        <div className="max-w-xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground text-sm mb-8">Tudo o que voc?? precisa para dominar suas finan??as.</p>
              ...
              <ul className="space-y-4 mb-12 text-left max-w-md mx-auto">
                {[
                  ...
                  "Hist??rico de transa????es completo",
                  "Consolida????o de Patrim??nio (Ativos/Passivos)",
                  "Intelig??ncia Artificial Lia ???? (Chat 24/7)",
                  "Relat??rios e Gr??ficos Avan??ados",
                  "Exporta????o PDF e Excel",
                  "Sincroniza????o em m??ltiplos dispositivos"
                ].map(item => (
              ...
              <Link to="/register">
                <Button variant="hero" className="w-full h-16 rounded-2xl text-xl font-black shadow-glow hover:scale-[1.02] transition-all">
                  Come??ar meu Teste Gr??tis
                </Button>
              </Link>
              <p className="mt-4 text-[10px] text-muted-foreground font-bold uppercase tracking-widest">Cancele quando quiser ??? 7 dias gr??tis</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative z-10 max-w-3xl mx-auto px-6 py-24 border-t border-border/50">
        ...
        <Accordion type="single" collapsible className="glass-strong p-8 rounded-[2.5rem] shadow-xl border-border/40">
          ...
          <AccordionItem value="2" className="border-border/50 py-2">
            ...
            <AccordionContent className="text-muted-foreground leading-relaxed pt-2">A Lia utiliza modelos de linguagem avan??ados treinados em finan??as brasileiras. Voc?? pode registrar gastos, pedir an??lises de faturas e simular metas apenas conversando.</AccordionContent>
          </AccordionItem>
          <AccordionItem value="3" className="border-transparent py-2">
            ...
            <AccordionContent className="text-muted-foreground leading-relaxed pt-2">Sim. Para garantir a seguran??a e evitar abusos na nossa infraestrutura de IA e Open Finance, solicitamos um cart??o v??lido. Voc?? n??o ser?? cobrado se cancelar antes dos 7 dias.</AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 py-24 text-center">
        <div className="glass-strong p-16 sm:p-24 rounded-[3.5rem] relative overflow-hidden shadow-glow">
          ...
          <p className="text-muted-foreground text-xl mb-12 max-w-lg mx-auto">Sua jornada rumo ao controle absoluto come??a com um simples passo.</p>
      ...
      <footer className="relative z-10 border-t border-border/50 py-24 bg-background/50">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-16 text-sm mb-20">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-muted-foreground leading-relaxed">O ecossistema definitivo para a sua evolu????o patrimonial e liberdade financeira.</p>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-muted-foreground font-bold">
              ...
              <li><Link to="#planos" className="hover:text-primary transition-colors">Planos e Pre??os</Link></li>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-12 border-t border-zinc-800/50 text-center">
          <p className="text-[10px] text-zinc-600">?? 2026 Liberta Finan??as LTDA. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div >
  );
